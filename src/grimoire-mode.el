...
(defun grimoire-mode-search-helper (command)
  "A function for the search helper"
  ...
  (insert
   (helm :sources (helm-build-async-source "aws-helm-source"
                   ...
                   (lambda ()
                     ...
                     (switch-to-buffer grimoire-buffer)
                     ;'(grimoire-mode-search-helper)
                     (start-process "bash" nil "/bin/bash" "-c"
                                    curl-search-command
                                    )
                     ; (start-process "bash" nil '(grimoire-mod-search-helper))
                     (grimoire-mode-search-helper)
